Contributing to kloudcoins Core
============================

The kloudcoins Core project operates an open contributor model where anyone is
...
The following applies to code changes to the kloudcoins Core project, and is not to be
confused with overall kloudcoins Network Protocol consensus changes.

Whether a pull request is merged into kloudcoins Core rests with the project merge
...
Patches that change kloudcoins consensus rules are considerably more involved than
...
Where a patch set proposes to change the kloudcoins consensus, it must have been
...
The project leader is the release manager for each kloudcoins Core release.
