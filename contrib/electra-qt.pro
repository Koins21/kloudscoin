...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/kloudcoins-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/kloudcoins-cli.cpp \
           src/kloudcoins-tx.cpp \
           src/kloudcoins.cpp \
           src/db.cpp \
           ...
           src/qt/kloudcoins.cpp \
           src/qt/kloudcoinsstrings.cpp \
...
RESOURCES += src/qt/kloudcoins.qrc src/qt/kloudcoins_locale.qrc

TRANSLATIONS += src/qt/locale/kloudcoins_bg.ts \
                src/qt/locale/kloudcoins_de.ts \
                src/qt/locale/kloudcoins_en.ts \
                src/qt/locale/kloudcoins_es.ts \
                src/qt/locale/kloudcoins_fi.ts \
                src/qt/locale/kloudcoins_fr.ts \
                src/qt/locale/kloudcoins_it.ts \
                src/qt/locale/kloudcoins_ja.ts \
                src/qt/locale/kloudcoins_pl.ts \
                src/qt/locale/kloudcoins_pt.ts \
                src/qt/locale/kloudcoins_ru.ts \
                src/qt/locale/kloudcoins_sk.ts \
                src/qt/locale/kloudcoins_sv.ts \
                src/qt/locale/kloudcoins_vi.ts \
                src/qt/locale/kloudcoins_zh_CN.ts \
                src/qt/locale/kloudcoins_zh_TW.ts
