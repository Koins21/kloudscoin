...
In order to support loading of multiple wallets in kloudcoins-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kloudcoins.cpp.
...
Changes to kloudcoins.cpp
----------------------
kloudcoins.cpp is the entry point into kloudcoins-qt, and as such, will require some minor modifications to provide hooks for
