...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("kloudcoins kloudcoins-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kloudcoins-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kloudcoins transaction") + "\n" +
                               "  kloudcoins-tx [options] -create [commands]   " + _("Create hex-encoded kloudcoins transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kloudcoins transaction
