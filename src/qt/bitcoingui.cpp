                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Kloudcoins Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&kloudcoins Project"), this);
    webmainAction->setStatusTip(tr("kloudcoins Project Website"));
    ...
    facebookAction->setStatusTip(tr("kloudcoins Facebook"));
    ...
    twitterAction->setStatusTip(tr("kloudcoins Twitter"));
    ...
    discordAction->setStatusTip(tr("kloudcoins Discord"));
    ...
    youtubeAction->setStatusTip(tr("kloudcoins Youtube"));
    ...
    telegramAction->setStatusTip(tr("kloudcoins Telegram"));
    ...
    redditAction->setStatusTip(tr("kloudcoins Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap kloudcoins"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell kloudcoins Coin (kloudcoins)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    kloudcoinsBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&kloudcoins block explorer"), this);
    kloudcoinsBlockExplorerAction->setStatusTip(tr("kloudcoins blockchain explorer"));
    kloudcoinsBlockExplorerAction->setToolTip(kloudcoinsBlockExplorerAction->statusTip());
    kloudcoinsBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&kloudcoins Project Github"), this);
    githubAction->setStatusTip(tr("kloudcoins Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a kloudcoins address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kloudcoins: URIs)"));
...
//    }
    ...
    connect(kloudcoinsBlockExplorerAction, SIGNAL(triggered()), this, SLOT(kloudcoinsBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About kloudcoins Core"), this);
    aboutAction->setStatusTip(tr("Show information about kloudcoins Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for kloudcoins"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your kloudcoins addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified kloudcoins addresses"));
    ...
    openAction->setStatusTip(tr("Open a kloudcoins: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the kloudcoins Core help message to get a list with possible kloudcoins command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(kloudcoinsBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("kloudcoins Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.kloudcoins.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/kloudcoins.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/kloudcoins4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/kloudcoinscryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/kloudcoins-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::kloudcoinsBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/kloudcoins/kloudcoins/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to kloudcoins network", "", count));
}
...
{
    QString strTitle = tr("kloudcoins Core"); // default title
