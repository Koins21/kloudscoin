...
/** Utility functions used by the kloudcoins Qt UI.
 */
namespace GUIUtil
{
...
// Render kloudcoins addresses in monospace font
...
// Parse "kloudcoins:" URI into recipient object, return true on successful parsing
