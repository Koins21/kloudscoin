...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case kloudcoins:
            return QString("tKDC");
        case mECA:
            return QString("mtKDC");
        case uECA:
            return QString::fromUtf8("μtKDC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case kloudcoins:
            return QString("KDC");
        case mECA:
            return QString("Milli-KDC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-KDC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case kloudcoins:
            return QString("TestKDC");
        case mECA:
            return QString("Milli-TestKDC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-TestKDC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
