...
/* kloudcoins GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "kloudcoins"
#define QAPP_ORG_DOMAIN "kloudcoinsproject.org"
#define QAPP_APP_NAME_DEFAULT "kloudcoins-Qt"
#define QAPP_APP_NAME_TESTNET "kloudcoins-Qt-testnet"
