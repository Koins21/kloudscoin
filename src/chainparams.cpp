...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "kloudcoins is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1623886709;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 11979883;
        ...
        assert(genesis.hashMerkleRoot == uint256("0xb26fc303f85238c24bc1d41980a8f9e8309f4eb41086ffb60cfd369aff0bbc2b"));
        assert(hashGenesisBlock == uint256("0x00000efa204f78f4bf4638b41fded2f3967e8490c94d5a119d7f4c2d2e74a94d"));

     
	vSeeds.push_back(CDNSSeedData("45.63.9.27","45.63.9.27"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xb26fc303f85238c24bc1d41980a8f9e8309f4eb41086ffb60cfd369aff0bbc2b"));
        assert(hashGenesisBlock == uint256("0x0000215fff61a4bdcd9a50d585ce7b01e61d30079d7c8f0c2c6a35d7aa78b62d"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xb26fc303f85238c24bc1d41980a8f9e8309f4eb41086ffb60cfd369aff0bbc2b"));
        assert(hashGenesisBlock == uint256("0x7301ac1af64aa9acc31ed15297fcd9750e3db8c52da64253448507bce6387195"));
