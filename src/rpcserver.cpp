...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop kloudcoins server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "kloudcoins server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* kloudcoins features */
        {"kloudcoins", "masternode", &masternode, true, true, false},
        {"kloudcoins", "listmasternodes", &listmasternodes, true, true, false},
        {"kloudcoins", "getmasternodecount", &getmasternodecount, true, true, false},
        {"kloudcoins", "masternodeconnect", &masternodeconnect, true, true, false},
        {"kloudcoins", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"kloudcoins", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"kloudcoins", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"kloudcoins", "masternodecurrent", &masternodecurrent, true, true, false},
        {"kloudcoins", "masternodedebug", &masternodedebug, true, true, false},
        {"kloudcoins", "startmasternode", &startmasternode, true, true, false},
        {"kloudcoins", "createmasternodekey", &createmasternodekey, true, true, false},
        {"kloudcoins", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"kloudcoins", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"kloudcoins", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"kloudcoins", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"kloudcoins", "getmasternodescores", &getmasternodescores, true, true, false},
        {"kloudcoins", "mnbudget", &mnbudget, true, true, false},
        {"kloudcoins", "preparebudget", &preparebudget, true, true, false},
        {"kloudcoins", "submitbudget", &submitbudget, true, true, false},
        {"kloudcoins", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"kloudcoins", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"kloudcoins", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"kloudcoins", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"kloudcoins", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"kloudcoins", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"kloudcoins", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kloudcoins", "checkbudgets", &checkbudgets, true, true, false},
        {"kloudcoins", "mnsync", &mnsync, true, true, false},
        {"kloudcoins", "spork", &spork, true, true, false},
        {"kloudcoins", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> kloudcoins-cli " + methodname + " " + args + "\n";
}
